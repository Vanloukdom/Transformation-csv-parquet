...
3. Créer une table Glue pour le fichier parquet.
4. Créer un job Glue pour transformer le fichier csv en parquet.
5. Exécuter le job Glue et vérifier que le fichier parquet est créé dans le bucket S3.
6. Nettoyer les ressources créées pour éviter des coûts inutiles.
